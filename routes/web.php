...
// Route::get('/login', 'php@index')->name('login');
Route::group(['middleware' => 'auth'], function () {
    ...
    //TODO by Team - korang sendiri
    // $path = base_path('Modules');
    // require "{$path}/WarCouncils/Routes/web.php";



    //Modules Route - genarate module using command - nwidart structure
    foreach (scandir($path = base_path('Modules')) as $dir) {
        if (file_exists($filepath = "{$path}/{$dir}/web.php")) {
            require $filepath;
        }
    }
