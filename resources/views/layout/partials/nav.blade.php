			...
			<div id="sidebar-menu" class="sidebar-menu">
				<ul>
					...
					<li class="submenu">
						...
						<ul style="display: none;">
							<li>
								<a class="{{ Request::is('index') ? 'active' : '' }}" href="{{ url('index') }}">Admin
									Dashboard
								</a>
							</li>
							<li>
								<a class="{{ Request::is('employee-dashboard') ? 'active' : '' }}"
									href="{{ url('employee-dashboard') }}">Employee Dashboard
								</a>
							</li>
						</ul>
					</li>
					<li>
						<a class="{{ Request::is('database') ? 'active' : '' }}" href="{{ route('table.index') }}">
					...
					@foreach ($menus as $menu)
						...
						<li class="text-white">
							...
							@foreach($menu->childs as $submenu)
								<li>
									<a href="{{route($submenu->route)}}">{{$submenu->title}}</a>
								</li>
							@endforeach
							</ul>
						</li>
				...
				<li>
					<a class="{{ Request::is('leaves') ? 'active' : '' }}" href="{{ url('leaves') }}">Leaves
						(Admin) <span class="badge badge-pill bg-primary float-right">1</span></a></li>
				...
				<li>
					<a class="{{ Request::is('attendance') ? 'active' : '' }}" href="{{ url('attendance') }}">Attendance
						(Admin)</a></li>
				...
				<li class="submenu">
					...
					<ul style="display: none;">
						...
						<li>
							<a class="{{ Request::is('performance') ? 'active' : '' }}" href="{{ url('performance') }}">
				...
				<li class="submenu">
					...
					<ul style="display: none;">
						...
						<li><a class="{{ Request::is('jobs') ? 'active' : '' }}" href="{{ url('jobs') }}"> Manage
								Jobs </a></li>
				...
				<li>
					<a class="{{ Request::is('client-profile') ? 'active' : '' }}" href="{{ url('client-profile') }}">
						Client Profile </a></li>
				...
				<li class="submenu">
					...
					<ul style="display: none;">
						...
						<li>
							<a class="{{ Request::is('blank-page') ? 'active' : '' }}" href="{{ url('blank-page') }}">
								Blank Page </a></li>
				...
				<li>
					<a class="{{ Request::is('form-horizontal') ? 'active' : '' }}" href="{{ url('form-horizontal') }}">
						Horizontal Form </a></li>

				<li>
					<a class="{{ Request::is('form-vertical') ? 'active' : '' }}" href="{{ url('form-vertical') }}">
						Vertical Form </a></li>
				...
				<li>
					<a class="{{ Request::is('form-validation') ? 'active' : '' }}" href="{{ url('form-validation') }}">
				...
				<li class="submenu">
					...
					<ul style="display: none;">
						...
						<li>
							<a class="{{ Request::is('data-tables') ? 'active' : '' }}" href="{{ url('data-tables') }}">
								Data Table </a></li>
