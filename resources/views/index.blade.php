					...
					<ul>
						...
						<li class="submenu">
							...
							<ul style="display: none;">
								...
								<li>
									<a class="{{ Request::is('leaves') ? 'active' : '' }}"
						...
						<li class="submenu">
							...
							<ul style="display: none;">
								...
								<li>
									<a class="{{ Request::is('trainers') ? 'active' : '' }}"
						...
						<li class="submenu">
							...
							<ul style="display: none;">
								...
								<li><a class="{{ Request::is('user-dashboard','user-all-jobs','saved-jobs','applied-jobs','interviewing','offered-jobs','visited-jobs','archived-jobs') ? 'active' : '' }}"
								...
								<li><a class="{{ Request::is('offer-approvals') ? 'active' : '' }}"
										href="{{ url('offer-approvals') }}"> Offer Approvals </a></li>
								<li><a class="{{ Request::is('experience-level') ? 'active' : '' }}"
										href="{{ url('experience-level') }}"> Experience Level </a></li>
								...
								<li>
									<a class="{{ Request::is('jobs-applicants') ? 'active' : '' }}"
										href="{{ url('jobs-applicants') }}"> Applied Candidates </a></li>
						...
						<li class="submenu">
							...
							<ul style="display: none;">
								...
								<li>
									<a class="{{ Request::is('faq') ? 'active' : '' }}" href="{{ url('faq') }}"> FAQ
									</a></li>

								<li>
									<a class="{{ Request::is('terms') ? 'active' : '' }}" href="{{ url('terms') }}">
										Terms </a></li>
						...
						<li class="submenu">
							...
							<ul style="display: none;">
								...
								<li>
									<a class="{{ Request::is('form-mask') ? 'active' : '' }}"
