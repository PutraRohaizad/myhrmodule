            ...
            <div class="row align-items-center">
                ...
                <div class="col-auto float-right ml-auto">
                    ...
                    <div class="view-icons">
                        <a href="{{route('projects.list')}}" class="grid-view btn btn-link"><i class="fa fa-th"></i></a>
                        <a href="{{route('projects.projectList')}}" class="list-view btn btn-link active"><i class="fa fa-bars"></i></a>
                    </div>
                </div>
            </div>
        </div>
