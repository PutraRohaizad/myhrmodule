    ...
    function addColumn(){
        ...
        $('#column').append(`
            <div class="row">
                ...
                <div class="col-md-2">
                    <label for="title" class="form-label">Nullableee</label>
                    <select class="form-control" name="columnnull[]" id="columnnull">
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/hrms_v2/Modules/Table/Resources/views/index.blade.php ENDPATH**/ ?>