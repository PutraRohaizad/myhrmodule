            ...
            <div class="page-wrapper">
                ...
                <div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row">
							<div class="col-sm-12">
								<h3 class="page-title">Welcome Natang!</h3>
								<ul class="breadcrumb">
					...
					<div class="row">
						<div class="col-12 mb-4">
							...
							<button type="button" class="btn btn-dark" onclick="setStyleSheet('css/style_dark.css')">Dark Theme</button>
							<button type="button" class="btn btn-primary" onclick="setStyleSheet('css/style.css')">Orange Theme</button>
							<button type="button" class="btn btn-info" onclick="setStyleSheet('css/style_blue.css')">Blue Theme</button>
							<button type="button" class="btn btn-light" onclick="setStyleSheet('css/style_light.css')">Light Theme</button>
							<button type="button" class="btn btn-danger" onclick="setStyleSheet('css/style_maroon.css')">Maroon Theme</button>
							<button type="button" class="btn btn-primary" style="background-color: rgb(114, 66, 226) !important;" onclick="setStyleSheet('css/style_purple.css')">Purple Theme</button>
							<button type="button" class="btn btn-primary" style="background-color: rgb(113, 112, 116) !important;" onclick="setStyleSheet('css/style_rtl.css')">RTL Theme</button>
						</div>
...
</html><?php /**PATH D:\xampp\htdocs\smarthr\resources\views/index.blade.php ENDPATH**/ ?>