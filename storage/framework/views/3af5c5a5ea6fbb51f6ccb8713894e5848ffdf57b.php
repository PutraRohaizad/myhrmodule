    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="<?php echo e(route('projects.list_add')); ?>" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="row">
                        <div class="col-sm-6">
...
<!-- /Create Project Modal --><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/myhrmodule/Modules/Projects/Resources/views/modal/add.blade.php ENDPATH**/ ?>