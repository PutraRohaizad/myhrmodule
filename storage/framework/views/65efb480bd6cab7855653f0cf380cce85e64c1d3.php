            ...
            <ul class="contacts">
              ...
              <li class="active dz-chat-user">
                <div class="d-flex bd-highlight">
                  <div class="img_cont">
                    <img src="<?php echo e(asset('images/avatar/1.jpg')); ?>" class="rounded-circle user_img" alt=""/>
              ...
              <li class="dz-chat-user">
                <div class="d-flex bd-highlight">
                  <div class="img_cont">
                    <img src="<?php echo e(asset('images/avatar/2.jpg')); ?>" class="rounded-circle user_img" alt=""/>
              ...
              <li class="dz-chat-user">
                <div class="d-flex bd-highlight">
                  <div class="img_cont">
                    <img src="<?php echo e(asset('images/avatar/3.jpg')); ?>" class="rounded-circle user_img" alt=""/>
                    <span class="online_icon"></span>
                  </div>
                  <div class="user_info">
              ...
              <li class="dz-chat-user">
                <div class="d-flex bd-highlight">
                  <div class="img_cont">
                    <img src="<?php echo e(asset('images/avatar/4.jpg')); ?>" class="rounded-circle user_img" alt=""/>
                    <span class="online_icon offline"></span>
                  </div>
                  <div class="user_info">
              ...
              <li class="dz-chat-user">
                <div class="d-flex bd-highlight">
                  <div class="img_cont">
                    <img src="<?php echo e(asset('images/avatar/5.jpg')); ?>" class="rounded-circle user_img" alt=""/>
                    <span class="online_icon offline"></span>
                  </div>
                  <div class="user_info">
          ...
          <div class="card-body msg_card_body dz-scroll" id="DZ_W_Contacts_Body3">
            <div class="d-flex justify-content-start mb-4">
              <div class="img_cont_msg">
                <img src="<?php echo e(asset('images/avatar/1.jpg')); ?>" class="rounded-circle user_img_msg" alt=""/>
              </div>
            ...
            <div class="d-flex justify-content-end mb-4">
              ...
              <div class="img_cont_msg">
            <img src="<?php echo e(asset('images/avatar/2.jpg')); ?>" class="rounded-circle user_img_msg" alt=""/>
              </div>
            </div>
            <div class="d-flex justify-content-start mb-4">
              <div class="img_cont_msg">
            ...
            <li>
              <div class="timeline-panel">
                <div class="media mr-2">
                  <img alt="image" width="50" src="<?php echo e(asset('images/avatar/1.jpg')); ?>">
                </div>
              ...
              <a class="timeline-panel text-muted" href="javascript:;">
                ...
                <h6 class="mb-0">Mashable, a news website and blog, goes live.</h6>
                  ...
                  <li class="nav-item dropdown header-profile">
                      <a class="nav-link" href="javascript:;" role="button" data-toggle="dropdown">
                          <img src="<?php echo e(asset('images/profile/12.png')); ?>" width="20" alt=""/>
        <div class="header-info">
          <span>David<i class="fa fa-caret-down ml-3" aria-hidden="true"></i></span>
        </div>
                      </a>
                      <div class="dropdown-menu dropdown-menu-right">
                          <a href="<?php echo url('/app-profile');; ?>" class="dropdown-item ai-icon">
                              <svg id="icon-user1" xmlns="http://www.w3.org/2000/svg" class="text-primary" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
                              <span class="ml-2">Profile </span>
                          </a>
                          <a href="<?php echo url('/email-inbox');; ?>" class="dropdown-item ai-icon">
                              <svg id="icon-inbox" xmlns="http://www.w3.org/2000/svg" class="text-success" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>
                              <span class="ml-2">Inbox </span>
                          </a>
                          <a href="<?php echo url('/page-login');; ?>" class="dropdown-item ai-icon">
...
</div><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/cara_module/resources/views/elements/header.blade.php ENDPATH**/ ?>