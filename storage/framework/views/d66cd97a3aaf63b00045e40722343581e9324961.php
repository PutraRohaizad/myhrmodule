<?php $__env->startSection('content'); ?>
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col">
                    <h3 class="page-title">Projectssss</h3>
                    <ul class="breadcrumb">
                ...
                <div class="col-auto float-right ml-auto">
                    ...
                    <div class="view-icons">
                        <a href="<?php echo e(route('projects.list')); ?>" class="grid-view btn btn-link"><i class="fa fa-th"></i></a>
                        <a href="<?php echo e(route('projects.projectList')); ?>" class="list-view btn btn-link active"><i class="fa fa-bars"></i></a>
                    </div>
                </div>
            </div>
        </div>
                                    ...
                                    <ul class="team-members text-nowrap">
                                        ...
                                        <li>
                                            <a href="#" title="Richard Miles" data-toggle="tooltip"><img alt=""
                                                    src="img/profiles/avatar-09.jpg"></a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="#" title="Mike Litorus" data-toggle="tooltip"><img alt=""
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/cara_module/Modules/Projects/Resources/views/project_list.blade.php ENDPATH**/ ?>